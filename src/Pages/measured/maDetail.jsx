      ...
      <div>
        ...
        <div class="my-5 max-w-sm rounded-xl overflow-hidden shadow bg-slate-300">
          <div className="m-6 justify-between">
            <p
              title="Username"
              class="hover:cursor-pointer  inline-block bg-gray-200 rounded-lg px-5 py-1 text-sm font-semibold text-gray-800 capitalize shadow-lg"
            >
              {user.name}
            </p>
            <p
              title="Role"
              class="hover:cursor-pointer mx-3 inline-block bg-gray-200 rounded-lg px-5 py-1 text-sm font-semibold text-gray-800  shadow-lg"
            >
              {user.role}
            </p>
          </div>
